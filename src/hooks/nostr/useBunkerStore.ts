...
import { filteredArray, jsonSchema, nostrIdSchema } from '@/schemas/utils.ts';
...
const connectionSchema = z.object({
  ...
  authorizedPubkey: nostrIdSchema,
  bunkerPubkey: nostrIdSchema,
});
  ...
  persist(
    ...
    }),
    {
      ...
      storage: {
        ...
        setItem(name, { state }) {
          getStorage()?.setItem(name, JSON.stringify(state.connections));
        },
        removeItem(name) {
