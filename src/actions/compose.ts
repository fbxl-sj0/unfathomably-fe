...
const COMPOSE_DRAFTS_HYDRATE = 'COMPOSE_DRAFTS_HYDRATE' as const;
...
const hydrateComposeDrafts = (drafts: Record<string, any>) => ({
  type: COMPOSE_DRAFTS_HYDRATE,
  drafts,
});
...
type ComposeAction =
  ...
  | ReturnType<typeof hydrateComposeDrafts>
  | ComposeReplyAction
