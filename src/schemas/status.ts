...
const statusBooleanSchema = z.coerce.boolean().catch(false);
...
const baseStatusSchema = z.object({
  ...
  muted: statusBooleanSchema,
  pinned: statusBooleanSchema,
  ...
  zapped: statusBooleanSchema,
  zaps_amount: z.number().catch(0),
  zapped_cashu: statusBooleanSchema,
