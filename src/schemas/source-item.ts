...
const sourceItemSchema = z.object({
  ...
  media_bitrate: z.number().nullable().catch(null),
  media_size: z.number().nullable().catch(null),
  album: z.string().nullable().catch(null),
  album_url: z.string().nullable().catch(null),
  artists: z.array(z.string()).catch([]),
  license: z.string().nullable().catch(null),
  copyright: z.string().nullable().catch(null),
  disc: z.number().nullable().catch(null),
  position: z.number().nullable().catch(null),
  musicbrainz_id: z.string().nullable().catch(null),
  musicbrainz_url: z.string().nullable().catch(null),
