...
const instanceV1Schema = instanceV1BaseSchema.transform((instance) => {
  const configuration = {
  ...
  if (typeof instance.max_toot_chars === 'number') {
    configuration.statuses.max_characters = instance.max_toot_chars;
  }

  if (typeof instance.max_media_attachments === 'number') {
    configuration.statuses.max_media_attachments = instance.max_media_attachments;
  }
