...
/** Nostr event and account public keys are 32-byte values encoded as hex. */
const nostrIdSchema = z.string().regex(/^[0-9a-f]{64}$/i);
...
export { filteredArray, hexColorSchema, emojiSchema, contentSchema, dateSchema, jsonSchema, mimeSchema, nostrIdSchema, coerceObject };
