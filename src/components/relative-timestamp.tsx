...
import { defineMessages, IntlShape, FormatDateOptions, useIntl } from 'react-intl';
...
const RelativeTimestampIntl: React.FC<Omit<RelativeTimestampProps, 'intl'>> = (props) => {
  const intl = useIntl();

  return <RelativeTimestamp {...props} intl={intl} />;
};

export default RelativeTimestampIntl;
