...
const familyClasses: Record<FederationFamily, string> = {
  ...
  models: 'bg-teal-100 text-teal-900 dark:bg-teal-900/30 dark:text-teal-100',
  games: 'bg-blue-100 text-blue-900 dark:bg-blue-900/30 dark:text-blue-100',
  marketplace: 'bg-yellow-100 text-yellow-900 dark:bg-yellow-900/30 dark:text-yellow-100',
  culture: 'bg-fuchsia-100 text-fuchsia-900 dark:bg-fuchsia-900/30 dark:text-fuchsia-100',
  ...
  development: 'bg-indigo-100 text-indigo-900 dark:bg-indigo-900/30 dark:text-indigo-100',
  coordination: 'bg-purple-100 text-purple-900 dark:bg-purple-900/30 dark:text-purple-100',
  publishing: 'bg-cyan-100 text-cyan-900 dark:bg-cyan-900/30 dark:text-cyan-100',
  routes: 'bg-green-100 text-green-900 dark:bg-green-900/30 dark:text-green-100',
