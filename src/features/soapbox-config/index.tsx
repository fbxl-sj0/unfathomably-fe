...
const messages = defineMessages({
  heading: { id: 'column.soapbox_config', defaultMessage: 'Unfathomably config' },
  saved: { id: 'soapbox_config.saved', defaultMessage: 'Unfathomably config saved!' },
  ...
  promoPanelIconsLink: { id: 'soapbox_config.hints.promo_panel_icons.link', defaultMessage: 'Unfathomably icons list' },
