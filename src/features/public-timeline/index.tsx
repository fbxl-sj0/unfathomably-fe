...
const PublicTimeline = () => {
  ...
  const [language, setLanguage] = useState<string>(window.localStorage.getItem('soapbox:global:language') || '');
  ...
  useEffect(() => {
    ...
    window.localStorage.setItem('soapbox:global:language', language);
  }, [language]);
