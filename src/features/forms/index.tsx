...
export const FileChooser: React.FC<IFileChooser> = ({ accept = ['image/jpeg', 'image/png', 'image/gif', 'image/webp'], ...props }) => (
  <SimpleInput type='file' accept={accept.join(',')} {...props} />
);
...
export const FileChooserLogo: React.FC<IFileChooserLogo> = ({ accept = ['image/svg', 'image/png'], ...props }) => (
  <SimpleInput type='file' accept={accept.join(',')} {...props} />
);
